...
<div class="container">
  <form action="thread_all.html" method="post" id="signup" class="form">
    ...
    <div class="form-group">
      <label>ユーザー名</label>
      <input type="text" name="username" value="<?= isset($app->username) ? h($app->getValues()->username): ''; ?>" class="form-control">
    ...
    <button class="btn btn-primary" oneclick="document.getElementById('signup').submit();">登録</button>
